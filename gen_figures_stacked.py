...
if __name__ == "__main__":
    ...
    trace1_pb = get_trace('./results/pretrained_berzerk_'+exp+'/pretrained_berzerk_'+exp+'_data.json', berzerk_normalizer, colors0, shw_lgd=True, lgd_name='Pre-trained on same<br>game as tested')
    trace2_kfb = get_trace('./results/krull_from_berzerk_'+exp+'/krull_from_berzerk_'+exp+'_data.json', krull_normalizer, colors1, shw_lgd=True, lgd_name='Pre-trained on<br>Berzerk')
    ...
    trace4_bfk = get_trace('./results/berzerk_from_krull_'+exp+'/berzerk_from_krull_'+exp+'_data.json', berzerk_normalizer, colors2, shw_lgd=True, lgd_name='Pre-trained on<br>Krull')
    ...
    trace7_bfr = get_trace('./results/berzerk_from_riverraid_'+exp+'/berzerk_from_riverraid_'+exp+'_data.json', berzerk_normalizer, colors3, shw_lgd=True, lgd_name='Pre-trained on<br>Riverraid')
