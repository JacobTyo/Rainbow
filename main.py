...
parser.add_argument('--experiment', type=str, default='testing', metavar='N',
                    help="The name of the experiment to save data under")
parser.add_argument('--plots-path', type=str, default='results', metavar='PATH', help='Where to save the plot results')
parser.add_argument('--data-save-path', type=str, default='results', metavar='PATH',
                    help='Where to save the data objects')
parser.add_argument('--reinitialize-layers', type=int, default=0, metavar='N',
                    help="The number of layers to reinitialize before training")
