...
if __name__ == "__main__":
    ...
    trace1_pb = get_trace('./results/scratch_berzerk_10M/scratch_berzerk_10M_data', 1, colors1)
    trace2_kfb = get_trace('./results/scratch_krull_10M/scratch_krull_10M_data', 1, colors2)
    trace3_rfb = get_trace('./results/scratch_riverraid_10M/scratch_riverraid_10M_data', 1, colors0)
    # trace4_bfk = get_trace('./results/berzerk_from_krull_'+exp+'/berzerk_from_krull_'+exp+'_data', berzerk_normalizer, colors2, shw_lgd=True, lgd_name='Pre-trained on<br>Krull')
    # trace5_pk = get_trace('./results/pretrained_krull_'+exp+'/pretrained_krull_'+exp+'_data', krull_normalizer, colors2)
    # trace6_rfk = get_trace('./results/riverraid_from_krull_'+exp+'/riverraid_from_krull_'+exp+'_data', riverraid_normalizer, colors2)
    # trace7_bfr = get_trace('./results/berzerk_from_riverraid_'+exp+'/berzerk_from_riverraid_'+exp+'_data', berzerk_normalizer, colors0, shw_lgd=True, lgd_name='Pre-trained on<br>Riverraid')
    # trace8_kfr = get_trace('./results/krull_from_riverriad_'+exp+'/krull_from_riverriad_'+exp+'_data', krull_normalizer, colors0)
    # trace9_pr = get_trace('./results/pretrained_riverraid_'+exp+'/pretrained_riverraid_'+exp+'_data', riverraid_normalizer, colors0)
    ...
    fig = plotly.tools.make_subplots(rows=1, cols=3, subplot_titles=['Berzerk', 'Krull', 'Riverraid'])
